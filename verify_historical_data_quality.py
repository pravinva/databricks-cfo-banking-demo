...
print("  3. ▶️  Run Phase 1: Enhanced Deposit Beta Model (45 min)")
print("  4. 📈 Review model performance and feature importance")

print("\n💡 To upload notebooks:")
print("  databricks workspace import notebooks/Phase1_Enhanced_Deposit_Beta_Model.py \\")
print("    /Users/your_username/Phase1_Enhanced_Deposit_Beta_Model --language PYTHON")
