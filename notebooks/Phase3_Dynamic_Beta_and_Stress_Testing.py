...
print("Starting Phase 3: Dynamic Beta Functions & Stress Testing")
print("=" * 80)
...
# Load historical deposit beta data (from Phase 1/2 models)
...
# Define features (same as Phase 2)
feature_cols = [
...
fixed_rate_assets = 40.0  # $40B in fixed-rate mortgages, securities
...
# MAGIC %md
# MAGIC ### Step 6.3: Register Phase 3 Model (Dynamic Beta)

# COMMAND ----------

# Note: Dynamic beta is primarily for stress testing, not day-to-day ALM
# Register for reference but don't set as @champion (keep Phase 2 as operational model)
...
with mlflow.start_run(run_name="phase3_dynamic_beta_stress_testing") as run:
    # Log parameters
    mlflow.log_params({
...
print(f"✓ Phase 3 model logged: {run_id_phase3}")
print("\n⚠️ NOTE: Phase 3 model is for STRESS TESTING only")
print("   Keep Phase 2 model as @champion for operational ALM")
...
# MAGIC
# MAGIC ### Phase 3 Implementation Complete:
# MAGIC
...
# MAGIC - ⚠️ Keep Phase 2 model as @champion for day-to-day risk management
