...
# MAGIC %md
# MAGIC # Approach 1: Enhanced Deposit Beta Model
# MAGIC
...
# MAGIC %md
# MAGIC ### Step 1.1: Create Enhanced Training Dataset with Approach 1 Features
...
SELECT
    ...
    -- APPROACH 1 ENHANCEMENT: Relationship Features (Moody's Category 3)
    r.product_count,
    ...
    -- APPROACH 1 ENHANCEMENT: Market Regime Features (Chen framework)
    ...
    -- APPROACH 1 ENHANCEMENT: Competitive Context (Abrigo Category 5)
...
print("✓ Created enhanced training dataset with Approach 1 features")
...
print(f"  - Approach 1 enhancements: {len(phase1_enhanced_features) - len(base_features)}")
...
mlflow.set_experiment("/Users/pravin.varma@databricks.com/deposit_beta_enhanced_approach1")
...
with mlflow.start_run(run_name="baseline_model") as run:
    ...
    print("=" * 80)
    print("BASELINE MODEL (Before Approach 1 Enhancements)")
    print("=" * 80)
...
# MAGIC %md
# MAGIC ### Step 2.3: Train Enhanced Model (Approach 1 Features)

# COMMAND ----------

with mlflow.start_run(run_name="approach1_enhanced_model") as run:
    params_enhanced = {
    ...
    print("=" * 80)
    print("APPROACH 1 ENHANCED MODEL (With Research-Based Features)")
    print("=" * 80)
...
plt.title('Top 20 Features by Importance - Approach 1 Enhanced Model')
plt.tight_layout()
plt.show()
...
# MAGIC
# MAGIC ### Approach 1 Enhancements Implemented:
# MAGIC
...
# MAGIC
# MAGIC ### Next Steps:
# MAGIC - **Approach 2 notebook:** Vintage analysis and component decay modeling (cohort survival, runoff forecasting)
# MAGIC - **Approach 3 notebook:** Dynamic beta functions and stress testing (CCAR/DFAST scenarios, EVE sensitivity)
