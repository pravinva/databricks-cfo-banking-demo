...
- **[JOBS_AND_SQL_WAREHOUSE_TROUBLESHOOTING.md](guides/JOBS_AND_SQL_WAREHOUSE_TROUBLESHOOTING.md)** ([PDF](guides/JOBS_AND_SQL_WAREHOUSE_TROUBLESHOOTING.pdf)) - Deployment checklist: SQL warehouses, Apps vs `app.yml`, jobs, upstream failures, audit
