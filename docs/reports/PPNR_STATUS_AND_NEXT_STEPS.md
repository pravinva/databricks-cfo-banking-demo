...
└────────────────┬────────────────────────────────────────────────┘
                 ...
                 ▼
┌─────────────────────────────────────────────────────────────────┐
│  Dashboard #5: CCAR Stress Testing Dashboard                     │
├─────────────────────────────────────────────────────────────────┤
...
- ✅ Sufficient for CCAR-style stress testing requirements (DFAST is legacy terminology)
...
3. Sufficient for CCAR-style regulatory stress testing requirements
...
3. CCAR stress testing: `ml_models.dynamic_beta_parameters`, `stress_test_results`, `gold_regulatory.lcr_daily` (DFAST is legacy term)
